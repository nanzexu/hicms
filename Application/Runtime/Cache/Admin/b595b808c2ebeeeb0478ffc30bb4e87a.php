...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <li>
                <a class="J_menuItem"><i class="fa fa-columns"></i> <span class="nav-label">系统管理</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a class="J_menuItem" href="<?php echo U('System/menuList');?>">菜单</a>
                    </li>
                </ul>
            </li>
            <li>
